...
const WeatherCard = () => {
    const { dados, unit } = useContext(WeatherCardContext)
                ...
                <div className="card">
                    ...
                    <div className='card-extra-info'>
                        <div className='feels_like'>
                            <p>Sensação</p>
                            <p>{dados.main.feels_like}º{unit.toLowerCase() === 'metric' ? 'C' : 'F'}</p>
                        </div>
                        ...
                        <div className='wind'>
                            <p>Vento</p>
                            <p>{dados.wind.speed} {unit.toLowerCase() === 'metric' ? 'Meters/s' : 'Miles/h'}</p>
                        </div>
                    </div>
